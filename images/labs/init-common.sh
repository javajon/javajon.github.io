...
# Ensure select parts of Kubernetes are ready
source 'launch.sh'

echo 'done' > /opt/.backgroundfinished

# Apply kubernetes dashboard for this lab
eventual_source '/opt/k8s-dashboard.sh'
# eventual_source '/opt/scripts/start_dashboard.sh'
